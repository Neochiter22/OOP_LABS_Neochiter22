...
Figure::Figure(const Figure& other) : 
    _x1(other._x1), _y1(other._y1), _x2(other._x2), _y2(other._y2), _x3(other._x3), _y3(other._y3), _x4(other._x4), _y4(other._y4) {}

Figure::Figure(Figure&& other) noexcept : 
    _x1(other._x1), _y1(other._y1), _x2(other._x2), _y2(other._y2), 
    _x3(other._x3), _y3(other._y3), _x4(other._x4), _y4(other._y4) {
    other._x1 = other._y1 = other._x2 = other._y2 = other._x3 = other._y3 = other._x4 = other._y4 = 0.0;
}
...
std::ostream& operator<<(std::ostream& out, const Figure& fig) {
    out << "Figure:" << std::endl;
    out << "  Point 1: (" << fig._x1 << ", " << fig._y1 << ")" << std::endl;
    out << "  Point 2: (" << fig._x2 << ", " << fig._y2 << ")" << std::endl;
    out << "  Point 3: (" << fig._x3 << ", " << fig._y3 << ")" << std::endl;
    out << "  Point 4: (" << fig._x4 << ", " << fig._y4 << ")" << std::endl;
    return out;
}

std::istream& operator>>(std::istream& in, Figure& fig) {
    std::cout << "Input points (x1 y1 x2 y2 x3 y3 x4 y4):" << std::endl;
